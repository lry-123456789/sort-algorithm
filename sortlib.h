/*
 * this header file is powered by LRY
 * support clang++ and g++ 
 * if want support auto operator ,please use C++11 or higher
 * ----------------------------------------------------------
 *                          COPYRIGHT 
 *                  all rights reserved (c) LRY
 * ----------------------------------------------------------
 * you can see this file and update this file by useing below link
 *       https://github.com/lry-123456789/sort-algorithm
 *  VERSION 1.0.1
*/
#pragma once
#if __cplusplus >= 201103L
#else
    #warning "this program might not run correctly"
#endif
#ifdef __clang__
class Sort
{
...
#else
#warning "Compliing with an unknown complier,this option might create errors"
#warning "WARNING unknown support status"
